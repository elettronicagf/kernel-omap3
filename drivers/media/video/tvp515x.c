...
static struct tvp515x_reg tvp515x_reg_list_default[] = {
	...
	{ TOK_WRITE, TVP5150_BRIGHT_CTL, 0xC0 },/* 0x09 */
	{ TOK_WRITE, TVP5150_SATURATION_CTL, 0x80 },/* 0x0a */
	{ TOK_WRITE, TVP5150_HUE_CTL, 0x0 },/* 0x0b */
	{ TOK_WRITE, TVP5150_CONTRAST_CTL, 0x80 },/* 0x0c */
...
static int tvp515x_s_config(struct v4l2_subdev *subdev, int irq,
				void *platform_data)
{
	enum tvp515x_std current_std;
...
static struct v4l2_subdev_file_ops tvp515x_subdev_file_ops = {
	.open   = tvp515x_open,
};
